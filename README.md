...
- **Live Dashboard:** [https://karachi-aqi-monitor.streamlit.app/](https://karachi-aqi-monitor.streamlit.app/)
...
├── data/
│   └── karachi_aqi_data.csv          # Tested offline fallback cache
...
| **Fallback Cache** | `karachi_aqi_data.csv` | **LIVE** | Pipeline stress tested to fallback and complete using local cache when cloud is offline. |
...
* **Project:** 10Pearls AQI Prediction System for Karachi, Sindh
